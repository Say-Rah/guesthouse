              ...
              >
                ...
                <div className="col-lg-6">
                  <div className="mb-4">
                    ...
                    <p>
                      Our certified agent is here to guide you through every step, offering
                      expert advice and personalized assistance. Whether you need help booking a
                      stay or have specific inquiries, we’re ready to provide a seamless experience.
                    </p>
                  </div>
                  ...
                  <a href="#" className="btn btn-dark py-3 px-4">
                    <i className="fa fa-calendar-alt me-2"></i>BOOK
                  </a>
                </div>
              </div>
            </div>
